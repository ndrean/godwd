...
Itinary.create!(start: "Barranquilla", end:"Cartagena", date: Faker::Date.between(from: Date.today, to: '2021-12-01'), start_gps:[10.9799669,-74.8013085 ], end_gps:[10.4195841,-75.5271224] , distance: 82)
Itinary.create!(start: "Soulac s/Mer", end: "Lège-Cap-Ferret", date: Faker::Date.between(from: Date.today, to: '2021-12-01'), start_gps:[45.513149,-1.1228789], end_gps:[44.7245776,-1.2232052], distance: 88)
